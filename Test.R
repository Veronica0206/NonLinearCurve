...
BLSGM_TIC_F <- getBLSGM_TIC_Fixed(dat = uni_dat, T_records = 1:10, traj_var = "Y", t_var = "T", x_var = c("x1", "x2"), paraNames = paraFixedTIC)

BLSGM_TIC_R <- getBLSGM_TIC_Random(dat = uni_dat, T_records = 1:10, traj_var = "Y", t_var = "T", x_var = c("x1", "x2"), paraNames = paraRandomTIC)
...
PBLSGM_F <- getPBLSGM_Fixed(dat = bi_dat, T_records = list(1:10, 1:10), traj_var = c("Y", "Z"), t_var = rep("T", 2), paraNames = paraBiFixed)

PBLSGM_R <- getPBLSGM_Random(dat = bi_dat, T_records = list(1:10, 1:10), traj_var = c("Y", "Z"), t_var = rep("T", 2), paraNames = paraBiRandom)

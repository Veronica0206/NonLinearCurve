getBLSGM_TIC_Fixed <- function(dat, T_records, traj_var, t_var, growth_cov, res_ratio = 4, rho = 0.1, starts = NA, loc = 1, scale = 0.25,
                               extraTries = NA, original = T, paraNames = NA, optimizer = "CSOLNP"){

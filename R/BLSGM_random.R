getBLSGM_Random <- function(dat, nT, traj_var, t_var, gv_adjust = 1, res_ratio = 4, rho = 0.1, starts = NA, loc = 1, scale = 0.25, extraTries = NA, paraNames, optimizer = "CSOLNP"){

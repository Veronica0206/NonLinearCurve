getCPMM_BLSGM <- function(dat, nT, nClass, traj_var, t_var, clus_cov, res_ratio = rep(4, 2), rho = rep(0.1, 2), starts = NA, prop_starts = rep(0.5, 2),
  ...
  model_mx <- mxModel("Cluster Predictor Mixture Model, BLSGM with Fixed Knots",
